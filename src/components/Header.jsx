...
,gap:"0.8rem"};
  return (
    <>
<Particlebackground sx={{position:"relative" , zIndex:0 ,width:"100%" , height:"100vh"}} className = "wow fadeIn data-wow-delay='2s'"></Particlebackground>
<Box sx={styles_box} className = "wow fadeIn  data-wow-delay = '2s'">
