...
export default function Contact() {
  return (
    <Box className = "wow fadeIn data-wow-delay = 8s" sx = {{width:"100%" , backgroundColor:"#2b2f4b" , position:"relative" , zIndex:1 , paddingBottom:"20px" , boxShadow:"rgba(0,0,0,0.35)"}}>
