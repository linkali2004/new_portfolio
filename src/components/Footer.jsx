...
export default function Footer() {
  return (
    <Box className = "wow fadeIn data-wow-delay = 8s" sx = {{width:"100%" , backgroundColor:"#2b2f4b" , position:"relative" , zIndex:1 , display:"flex" , justifyContent:"space-evenly" , flexDirection:{sm:"column" ,xs :"column" , lg:"row" , alignItems:"center"}}}>
